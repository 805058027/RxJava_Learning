...
import com.example.administrator.rxjava_learning.FunctionalityOperator.RepeatActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.btn1, R.id.btn2, R.id.btn3, R.id.btn4, R.id.btn5, R.id.btn6, R.id.btn7, R.id.btn8,
            ...
            R.id.btn25, R.id.btn26, R.id.filter, R.id.filter1, R.id.btn27})
    public void OnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.filter:
                ...
                break;
            case R.id.filter1:
                startActivity(new Intent(this, BooleanActivity.class));
                break;
            case R.id.btn27:
